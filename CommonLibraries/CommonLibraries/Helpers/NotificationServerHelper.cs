...
namespace CommonLibraries.Helpers
{
  ...
  {
    private const string FollowNotificationUrl = "http://localhost:6660/internal/follow";
    private const string CommentNotificationUrl = "http://localhost:6660/internal/comment";
    private const string RecommendQuestionNotificationUrl = "http://localhost:6660/internal/recommendQuestion";
