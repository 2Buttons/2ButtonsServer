...
namespace CommonLibraries.Helpers
{
  ...
  {
    private const string AddMonitoringServerUrl = "http://localhost:6670/monitoring/add";
    private const string UpdateMonitoringServerUrl = "http://localhost:6670/monitoring/update";
