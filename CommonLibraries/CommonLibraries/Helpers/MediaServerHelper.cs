...
namespace CommonLibraries.Helpers
{
  public class MediaServerHelper
  {
    ...
    private const string UploadedAvaterUrl = "http://localhost:6550/upload/avatar/link";
    private const string UploadedAvaterFile = "http://localhost:6550/upload/avatar/file";
    private const string StandardAvatarUrl = "http://localhost:6550/standards/avatar/";

    private const string UploadedBackgroundUrl = "http://localhost:6550/upload/background/link";
    private const string UploadedBackgroundFile = "http://localhost:6550/upload/background/file";
    private const string StandardBackgroundUrl = "http://localhost:6550/standards/background/";
