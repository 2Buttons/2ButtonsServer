...
namespace CommonLibraries.Helpers
{
  public class MediaServerHelper
  {
    ...
    private const string StandardAvatarUrl = "http://localhost:15000/media/standards/avatar/";

    private const string UploadedBackgroundUrl = "http://localhost:15000/media/upload/background/link";
    private const string UploadedBackgroundFile = "http://localhost:15000/media/upload/background/file";
    private const string StandardBackgroundUrl = "http://localhost:15000/media/standards/background/";
