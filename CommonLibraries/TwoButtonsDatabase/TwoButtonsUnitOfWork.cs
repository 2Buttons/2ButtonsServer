...
namespace TwoButtonsDatabase
{
  public class TwoButtonsUnitOfWork : IDisposable
  {
    ...
    public FollowersRepository Followers => _followersRepository ??
                                            (_followersRepository = new FollowersRepository(_db));
    ...
    public RecommendedPeopleRepository RecommendedPeople => _recommendedSubscribersRepository ??
                                                            (_recommendedSubscribersRepository =
                                                              new RecommendedPeopleRepository(_db));
