...
public class QuestionsController {
    ...
    public int saveFeedback(@RequestParam(value = "id", required = true) int id,
                            @RequestParam(value = "questionId", required = true) int questionId,
                            @RequestParam(value = "feedback", required = false, defaultValue = "0") int feedback) {
    ...
    public int saveFavorites(@RequestParam(value = "id", required = true) int id,
                             @RequestParam(value = "questionId", required = true) int questionId,
                             @RequestParam(value = "inFavorites", required = false, defaultValue = "0") int inFavorites) {
        MsSqlConnection connection = new MsSqlConnection();
    ...
    public int saveAnswer(@RequestParam(value = "id", required = true) int id,
                          @RequestParam(value = "questionId", required = true) int questionId,
